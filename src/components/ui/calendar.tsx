  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-light-3 text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
        day_today: "bg-light-4 text-accent-foreground",
      ...
      components={{
        ...
        Dropdown: ({ ...props }) => (
          ...
          >
            ...
            <SelectContent className="max-h-[var(--radix-popper-available-height);] overflow-y-auto scrolling-auto min-w-[var(--radix-popper-anchor-width)] bg-white">
              {props.children &&
